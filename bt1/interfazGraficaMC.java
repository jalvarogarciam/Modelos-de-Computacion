...
public class interfazGraficaMC extends JFrame {
    ...
    private JMenuBar crearMenuBar(){
        ...
        agregarItemMenu(menuHerramientas, "Random Generator");
    ...
    private void agregarItemMenu(JMenu menu, String texto) {
        ...
        if (texto.equals("Random Generator")){
            System.out.println("Abriendo ventana de Random Generator...");
            item.addActionListener(e -> new randomGeneratorGUI().setVisible(true));
        }else{
